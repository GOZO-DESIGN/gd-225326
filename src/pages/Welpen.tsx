...
const galleries: Record<GalleryTab, { label: string; birthday: string; images: string[]; media?: MediaItem[] }> = {
  ...
  "welpen-27-04-24": { label: "Welpen gep. 27.04.2024", birthday: "27.04.2024", images: welpen270424Images },
  "welpen-30-01-24": { label: "Welpen geb. 30.01.24", birthday: "30.01.2024", images: [...whatsapp0726Images, ...whatsapp0807Images, ...whatsapp0808Images, ...whatsapp0813Images] },
