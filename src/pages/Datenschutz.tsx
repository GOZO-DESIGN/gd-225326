  ...
  return (
    <>
      <SEOHead
        ...
        description="Datenschutzerklärung der Pomeranian-Zucht Anne & Georg – Informationen zur Datenerfassung, Cookies und Ihren Rechten."
        canonical="https://www.pomeranianzucht-sachsen-anhalt.de/datenschutz"
      />
      <Navbar />
        ...
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          <AnimateOnScroll variant="fade-up">
            ...
            <div className="prose prose-lg max-w-none space-y-8 font-body text-foreground/90 [&_h2]:text-2xl [&_h2]:font-heading [&_h2]:text-foreground [&_h2]:mt-10 [&_h2]:mb-4 [&_h3]:text-xl [&_h3]:font-heading [&_h3]:text-foreground [&_h3]:mt-6 [&_h3]:mb-3 [&_a]:text-primary [&_a]:underline [&_ul]:list-disc [&_ul]:pl-6">
              ...
              <p>Anne-Katrin Müller<br />Pomeranian Zucht<br />Marienroda 4<br />06647 Finneland</p>
              <p>Telefon: 034465/690366<br />E-Mail: annekatrinmuller@rocketmail.com</p>
              ...
              <p>Unsere Website nutzt die Cookie-Consent-Technologie von Consent Manager Provider, um Ihre Einwilligung zur Speicherung bestimmter Cookies auf Ihrem Endgerät einzuholen und diese datenschutzkonform zu dokumentieren. Anbieter dieser Technologie ist die Jaohawi AB, Håltegelvägen 1b, 72348 Västerås, Schweden, Webseite: <a href="https://www.consentmanager.de" target="_blank" rel="noopener noreferrer">https://www.consentmanager.de</a> (im Folgenden „Consent Manager Provider").</p>
              ...
              <p>Der Einsatz von Consent Manager Provider erfolgt, um die gesetzlich vorgeschriebenen Einwilligungen für den Einsatz von Cookies einzuholen. Rechtsgrundlage hierfür ist Art. 6 Abs. 1 S. 1 lit. c DSGVO.</p>
              <p><strong>Vertrag über Auftragsverarbeitung</strong></p>
              <p>Wir haben einen Vertrag über Auftragsverarbeitung mit Consent Manager Provider geschlossen. Hierbei handelt es sich um einen datenschutzrechtlich vorgeschriebenen Vertrag, der gewährleistet, dass Consent Manager Provider die personenbezogenen Daten unserer Websitebesucher nur nach unseren Weisungen und unter Einhaltung der DSGVO verarbeitet.</p>
